...
import styles from './LearnAdjectives.module.css'
...
function LearnAdjectives() {
    ...
    return (
        <div className={styles.learnAdjectives}>
            <Headline headline={`${words.learn} ${words.adjectives}`}/>
...
export default LearnAdjectives;